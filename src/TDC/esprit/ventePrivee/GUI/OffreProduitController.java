 ...
 */
public class OffreProduitController implements Initializable{
     ...
     //Parent root = null ;
       ...
       //affichage lors de la selection
        table_produit.setOnMouseClicked(e -> {
          ...
          //   String req="select P.id_produit,P.libelle_prd,P.prix_prd,P.dateAjout_prd,U.id_user,U.nom_user,U.prenom_user,U.adresse_user,U.email_user,U.tel_user from produit P, utilisateur U on P.id_user=U.id_user where id_produit=? and id_user=?";
   ...
   /// Affichage des données dans un observableArrayList()
    public void ShowObservableArrayFxListOffreProduit(){
        ...
        try {
            ...
            while (res.next()){
                ...
                data.add(new Produit(res.getInt("id_produit"),res.getDouble("prix_prd"),res.getString("libelle_prd"),res.getString("description_prd"),res.getString("dateAjout_prd"),res.getString("categorie_prd"),res.getInt("id_user")));
            } 
           ...
           categorie_col.setCellValueFactory(new PropertyValueFactory<Produit,String>("categorie_prd"));
            ...
            id_user_col.setCellValueFactory(new PropertyValueFactory<Produit,Integer>("idUser"));
    ...
    @FXML
    private void RetourPrincipale(ActionEvent event) throws IOException {
        ...
        if (event.getSource()==consulter_id) {
            ...
            root=FXMLLoader.load(getClass().getResource("InterfaceConsultationProduit.fxml"));
              ...
              //create a new scene with root and set the stage// Creer un nouveau scène 
                 Scene scene=new Scene(root);
                 stage.setScene(scene);
                 stage.setTitle("Interface Consultation Produit");
                 stage.show();
        }
